...
function PrepareDailyHistoricalPriceMock() {
     ...
     */
    var content = fs.readFileSync("./tests/mock/binance-klines-QSPETH.json", {
        encoding: "UTF8"
    });
    ...
    /*!
     * https://api.binance.com/api/v1/klines?symbol=BTCUSDT&interval=1d&startTime=1509494400000&endTime=1512086400000
     * data from 2017-11-01 to 2017-12-01
     * created at 2017-12-10 03:25:44 GMT
     */
    content = fs.readFileSync("./tests/mock/binance-klines-BTCUSDT.json", {
        encoding: "UTF8"
    });
